...
const components = {
  ...
  h1: (props: ComponentPropsWithoutRef<"h1">) => (
    <h1
      className="text-3xl font-bold text-gray-900 dark:text-white mb-6 mt-8"
      {...props}
    />
  ),
  h2: (props: ComponentPropsWithoutRef<"h2">) => (
    <h2
      className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 mt-6"
      {...props}
    />
  ),
  h3: (props: ComponentPropsWithoutRef<"h3">) => (
    <h3
      className="text-xl font-medium text-gray-900 dark:text-white mb-3 mt-4"
      {...props}
    />
  ),
  ...
  blockquote: (props: ComponentPropsWithoutRef<"blockquote">) => (
    <blockquote
      className="border-l-4 border-theme-accent-gold pl-4 italic text-gray-600 dark:text-gray-400 my-6"
      {...props}
    />
  ),
